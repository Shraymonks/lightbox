...
var Lightbox = function () {
	...
	_createClass(Lightbox, [{
		...
		key: 'openPrevious',
		value: function openPrevious(event) {
			event.stopPropagation();
			this.open(this.currentIndex - 1);
		}
	}, {
		...
		value: function initElements() {
			...
			this.image.addEventListener('load', function () {
				_this.preload(_this.currentIndex + 1);
				_this.preload(_this.currentIndex - 1);
			});
			...
			document.addEventListener('keyup', function (event) {
				switch (event.keyCode) {
					...
					// left
					case 37:
						_this.open(_this.currentIndex - 1);
						break;
...
var _Gallery = __webpack_require__(118);

var _Gallery2 = _interopRequireDefault(_Gallery);

var _Lightbox = __webpack_require__(85);

var _Lightbox2 = _interopRequireDefault(_Lightbox);

var _Thumbnail = __webpack_require__(86);
...
var _Photos = __webpack_require__(119);
...
var Gallery = function () {
	function Gallery() {
		...
		(0, _Photos.getPhotos)().then(function (photos) {
			_this.photos = photos;
			_this.lightbox = new _Lightbox2.default(photos);
			_this.render();
		});
	}
		...
		value: function render() {
			...
			if (this.photos.length) {
				(function () {
					...
					_this2.photos.forEach(function (photo, index) {
						var handleThumbnailClick = function handleThumbnailClick() {
							return _this2.lightbox.open(index);
						};

						var thumbnail = new _Thumbnail2.default(_extends({}, photo, {
					...
					_this2.root.appendChild(fragment);
				})();
			}
...
var getPhotos = exports.getPhotos = function () {
			...
			while (1) {
				switch (_context.prev = _context.next) {
					...
					case 5:
						...
						return _context.abrupt('return', data.photoset.photo);
...
var API_KEY = '2b809457614f4727b3d900deb9a33341';

var ENDPOINT = 'https://api.flickr.com/services/rest/?method=flickr.photosets.getPhotos&api_key=' + API_KEY + '&format=json&nojsoncallback=1&photoset_id=72157647495646843&extras=url_sq,url_m';
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(115), __webpack_require__(301)))
